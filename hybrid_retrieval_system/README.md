Hybrid Vector + Graph Retrieval Engine
Devfolio Hackathon Submission
Team: Catalyst Crew 🚀
📌 Overview
...
✔ Semantic + graph hybrid relevance
...
Name: Paris
Text: Paris is the capital of France. It contains the Eiffel Tower.
...
Delete ID = Paris
Edges referencing Paris are automatically removed.
...
Built with passion, innovation, and absolutely no reliance on pre-built vector DBs/grapDBs.
A fully original, scratch-built hybrid AI retrieval engine.